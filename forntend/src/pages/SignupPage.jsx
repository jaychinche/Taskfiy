...
const SignupPage = () => {
  ...
  // Inline styles matching the LoginPage
  const styles = {
    container: {
      minHeight: '100vh',
        ...
        <div style={styles.card}>
          ...
          <div style={styles.header}>
            <div style={styles.logo}>
              <svg style={styles.userPlusIcon} fill="currentColor" viewBox="0 0 20 20">
          ...
          <form style={styles.form} onSubmit={handleSignup}>
            ...
            <button
              ...
              onMouseEnter={(e) => !isLoading && Object.assign(e.target.style, styles.signupButtonHover)}
          ...
          <div style={styles.footer}>
            <p style={styles.footerText}>
              ...
              <Link 
                ...
                onMouseEnter={(e) => Object.assign(e.target.style, styles.loginLinkHover)}
